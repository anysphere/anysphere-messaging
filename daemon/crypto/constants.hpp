...
static_assert(
    ...
    "ASYNC_INVITATION_SIZE (because we also have the public ID in there");
...
constexpr auto RELEASE_COMMIT_HASH = "d0d91b0caf8cd0e495572d95557ba83758cf4a9e";
...
constexpr auto AMAZON_ROOT_CERTS = R"EOM(# Operating CA: Amazon Trust Services
...
# Operating CA: Amazon Trust Services
