...
Status DaemonImpl::RegisterUser(
...
Status DaemonImpl::GetFriendList(
    ServerContext* context,
...
Status DaemonImpl::GenerateFriendKey(
    ServerContext* context,
...
Status DaemonImpl::AddFriend(
    ServerContext* context, const Daemon::AddFriendRequest* addFriendRequest,
...
Status DaemonImpl::RemoveFriend(
    ServerContext* context,
...
Status DaemonImpl::GetAllMessages(
    ServerContext* context,
