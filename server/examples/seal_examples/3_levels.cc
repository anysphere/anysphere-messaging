...
void example_levels() {
  ...
  */
  ...
  some of the most important levels:
      ...
      SEALContext::first_context_data(): access to highest data level
  ContextData SEALContext::last_context_data(): access to lowest level
  ContextData
  ...
  */
  ...
  cout << "    + plain:       " << plain.parms_id() << " (not set in BFV)"
       << endl;
  ...
  */
  decryptor.decrypt(encrypted, plain);
  cout << "    + Decryption of the 8th power (hexadecimal) ...... Correct."
       << endl;
