...
\hrule
\vspace{5pt}
{\color{red} \textbf{Hybrid 1'}: if $\reg_r \in \reg_{\cH}$, skip this method.}
\begin{enumerate}
...
\todo{The rest of the proof is really obvious but less obvious to write, since \cref{defn:pir-security} is much less powerful than \cref{defn:sym-security}}
