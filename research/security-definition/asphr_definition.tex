...
\todo{Compare with simplePIR paper: our scheme works for general PIR schemes?}
...
\begin{itemize}
    ...
    \item User $A$ will provide "feedback" $f(m)$ to user $C$'s message $m$. This could be an $\ACK$ message in our system, or simply a verbal response to $C$'s message.  
\end{itemize}
