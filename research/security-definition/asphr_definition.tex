...
\end{definition}
\todo{The following definition has not existed in literature(as communicated by Prof. Angel). Do we want a proof?}

\todo{The "Private Signaling" paper seems to contain a related definition?}
...
\todo{This definition is equivalent to https://eprint.iacr.org/2022/081.pdf, Experiment 2.2}
\begin{figure}[h!]
\begin{framed}
\textbf{Real World Experiment}
\begin{enumerate}
...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \item $ct_r^1 \leftarrow \Sim(1^{\lambda}, n, pk)$.
    \end{enumerate}
\end{enumerate}
\end{framed}
\end{figure}
