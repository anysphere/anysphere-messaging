...
Our protocol, $\Pi_{\asphr}$, implements the methods of \cref{def:messaging-scheme} as below. In any of the methods, we assume the caller will store all inputs for future use.
\vspace{10pt}
...
\hrule
\vspace{5pt}
The client initializes the following
\end{definition}
\end{framed}
\end{figure}
\end{document}